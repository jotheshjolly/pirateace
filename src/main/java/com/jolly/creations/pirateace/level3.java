...
public class level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wv1.loadUrl("https://pirate-project.hariom04.repl.co/level3.html");
        ...
        wv1.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(final WebView webView, int errorCode, String description, String failingUrl) {
                ...
                //load("about:blank");
                AlertDialog alertDialog = new AlertDialog.Builder(level3.this).create();
        ...
        enter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(answers.getText().toString().equals("23"))
                {
