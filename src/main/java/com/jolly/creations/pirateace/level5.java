...
public class level5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wv1.loadUrl("https://pirate-project.hariom04.repl.co/level5.html");
        ...
        wv1.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedError(final WebView webView, int errorCode, String description, String failingUrl) {
                ...
                //load("about:blank");
                AlertDialog alertDialog = new AlertDialog.Builder(level5.this).create();
        ...
        enter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(answers.getText().toString().equals("8"))
                {
                    Toast.makeText(getApplicationContext(),"correct",Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(level5.this,certificate.class));
                }
                else
                {
